...
)
{
    ...
    if (handler)
    {
        result = d_test_handler_register_listener(handler,
                     D_TEST_EVENT_START,
                     callback_start,
                     true);
...
)
{
    ...
    result = d_test_handler_unregister_listener(NULL,
                 D_TEST_EVENT_START);
    ...
    if (handler)
    {
        result = d_test_handler_unregister_listener(handler,
                     D_TEST_EVENT_START);
...
)
{
    ...
    // enable on NULL handler returns false
    result = d_test_handler_enable_listener(NULL,
                 D_TEST_EVENT_START);
    ...
    // disable on NULL handler returns false
    result = d_test_handler_disable_listener(NULL,
                 D_TEST_EVENT_START);
    ...
    if (handler)
    {
        result = (d_test_handler_enable_listener(
                      handler,
