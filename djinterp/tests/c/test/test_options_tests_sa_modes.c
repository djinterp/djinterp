...
)
{
    ...
    result = d_assert_standalone(
        D_TEST_OPTIONS_PRESET_SILENT == D_TEST_MODE_SILENT,
        "preset_silent",
        "PRESET_SILENT should equal MODE_SILENT",
        _counter) && result;

    result = d_assert_standalone(
        D_TEST_OPTIONS_PRESET_MINIMAL == D_TEST_MODE_MINIMAL,
        "preset_minimal",
        "PRESET_MINIMAL should equal MODE_MINIMAL",
        _counter) && result;

    result = d_assert_standalone(
        D_TEST_OPTIONS_PRESET_NORMAL == D_TEST_MODE_NORMAL,
        "preset_normal",
        "PRESET_NORMAL should equal MODE_NORMAL",
        _counter) && result;

    result = d_assert_standalone(
        D_TEST_OPTIONS_PRESET_VERBOSE == D_TEST_MODE_VERBOSE,
        "preset_verbose",
