...
* suppresses below it.
*
* path:      /inc/djinterp/core/text/pdf/pdf_printer.hpp
* link(s):   TBA
...
#ifndef DJINTERP_TEXT_PDF_PRINTER_
#define DJINTERP_TEXT_PDF_PRINTER_ 1
...
#include "../writer.hpp"                // string_sink, stream_sink (generic sinks)
...
#endif  // DJINTERP_TEXT_PDF_PRINTER_