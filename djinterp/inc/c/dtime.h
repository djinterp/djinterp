...
VIII. TIMESPEC NORMALIZATION
      ----------------------
      1. d_timespec_normalize
      2. d_timespec_is_valid
*/
...
int        d_strftime_s(char* _s, size_t _maxsize, const char* _format, const struct tm* _tm);

// VI. time arithmetic
void       d_timespec_add(const struct timespec* _a, const struct timespec* _b, struct timespec* _result);
void       d_timespec_sub(const struct timespec* _a, const struct timespec* _b, struct timespec* _result);
int        d_timespec_cmp(const struct timespec* _a, const struct timespec* _b);
