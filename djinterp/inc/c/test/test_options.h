...
*
* 
* path:      /inc/c/test/test_options.h
* link(s):   TBA
...
// D_TEST_OPTIONS_INDENT
//   alias: legacy alias for D_TEST_OPTIONS_INDENT_STR
#define D_TEST_OPTIONS_INDENT D_TEST_OPTIONS_INDENT_STR
...
#define D_TEST_OPTIONS_PRESET_SILENT   D_TEST_MODE_SILENT
#define D_TEST_OPTIONS_PRESET_MINIMAL  D_TEST_MODE_MINIMAL
#define D_TEST_OPTIONS_PRESET_NORMAL   D_TEST_MODE_NORMAL
#define D_TEST_OPTIONS_PRESET_VERBOSE  D_TEST_MODE_VERBOSE
...
struct d_test_options* d_test_options_new(uint32_t _flags);
struct d_test_options* d_test_options_new_preset(uint32_t _preset);
struct d_test_options* d_test_options_new_copy(const struct d_test_options* _other);

// config value accessors
bool        d_test_options_get_bool(const struct d_test_options* _config, uint32_t _key);
size_t      d_test_options_get_size_t(const struct d_test_options* _config, uint32_t _key);
int32_t     d_test_options_get_int32(const struct d_test_options* _config, uint32_t _key);
uint32_t    d_test_options_get_uint32(const struct d_test_options* _config, uint32_t _key);
const char* d_test_options_get_string(const struct d_test_options* _config, uint32_t _key);
void*       d_test_options_get_ptr(const struct d_test_options* _config, uint32_t _key);

// config value setters
bool d_test_options_set_bool(struct d_test_options* _config, uint32_t _key, bool _value);
bool d_test_options_set_size_t(struct d_test_options* _config, uint32_t _key, size_t _value);
bool d_test_options_set_int32(struct d_test_options* _config, uint32_t _key, int32_t _value);
bool d_test_options_set_uint32(struct d_test_options* _config, uint32_t _key, uint32_t _value);
bool d_test_options_set_string(struct d_test_options* _config, uint32_t _key, const char* _value);
bool d_test_options_set_ptr(struct d_test_options* _config, uint32_t _key, void* _value);

// key lookup from string
enum DTestConfigKey d_test_options_key_from_string(const char* _key);

void                d_test_options_free(struct d_test_options* _config);
