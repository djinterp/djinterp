...
*
* djinterp container configurable option traits module
...
NS_INTERNAL
    ...
    template<typename _Type>
    using opt_safe_value_type_t = typename opt_safe_value_type<_Type>::type;
...
template<typename _Type>
inline constexpr bool is_option_set_container_v = is_option_set_container<_Type>::value;
...
template<typename _Type>
inline constexpr bool has_option_entry_elements_v = has_option_entry_elements<_Type>::value;
...
template<typename _Type>
inline constexpr bool has_named_option_elements_v = has_named_option_elements<_Type>::value;
...
template<typename _Type>
inline constexpr bool has_documented_option_elements_v = has_documented_option_elements<_Type>::value;
...
template<typename _Type>
inline constexpr bool has_constrained_option_elements_v = has_constrained_option_elements<_Type>::value;

// has_env_mapped_option_elements
//   type trait: true if the container's value_type has
// an env_var member for environment-variable fall.
template<typename _Type>
...
template<typename _Type>
inline constexpr bool has_env_mapped_option_elements_v = has_env_mapped_option_elements<_Type>::value;
...
template<typename _Type>
inline constexpr bool is_configurable_container_v = is_configurable_container<_Type>::value;
...
template<typename _Type>
inline constexpr bool is_option_producing_container_v = is_option_producing_container<_Type>::value;
...
template<typename _Type>
inline constexpr bool is_cli_capable_container_v = is_cli_capable_container<_Type>::value;
...
struct has_from_options_factory
{
    ...
    static constexpr bool value = internal::has_from_options_check<clean_type>::value;
};

template<typename _Type>
inline constexpr bool has_from_options_factory_v = has_from_options_factory<_Type>::value;
...
NS_INTERNAL
    ...
    struct option_configure_strategy_helper
    {
        ...
        static constexpr option_configure_strategy value =
            has_apply_options_method_v<clean_type>
                ...
                : has_configure_method_v<clean_type>
                    ...
                    : has_set_option_method_v<clean_type>
                        ...
                        : is_option_set_container_v<clean_type>
                            ...
                            : option_configure_strategy::unsupported;
    };
...
{
    static constexpr option_configure_strategy value = internal::option_configure_strategy_helper<_Type>::value;
};

template<typename _Type>
inline constexpr option_configure_strategy container_option_configure_strategy_v = container_option_configure_strategy<_Type>::value;
...
NS_INTERNAL
    ...
    template<typename _Type>
    struct option_parse_strategy_helper
    {
        using clean_type = clean_t<_Type>;

        static constexpr option_parse_strategy value =
            has_parse_args_method_v<clean_type>
...
{
    static constexpr option_parse_strategy value =
        internal::option_parse_strategy_helper<_Type>::value;
};

template<typename _Type>
inline constexpr option_parse_strategy container_option_parse_strategy_v = container_option_parse_strategy<_Type>::value;
...
template<typename _Type>
inline constexpr bool has_any_option_support_v = has_any_option_support<_Type>::value;
...
template<typename _Type>
inline constexpr bool is_option_round_trip_capable_v = is_option_round_trip_capable<_Type>::value;
...
{
    // option storage
    static constexpr bool is_option_set           = is_option_set_container_v<_Type>;
    static constexpr bool has_option_entries      = has_option_entry_elements_v<_Type>;
    static constexpr bool has_named_entries       = has_named_option_elements_v<_Type>;
    static constexpr bool has_documented_entries  = has_documented_option_elements_v<_Type>;
    static constexpr bool has_constrained_entries = has_constrained_option_elements_v<_Type>;
    static constexpr bool has_env_mapped_entries  = has_env_mapped_option_elements_v<_Type>;
    // configurable
    static constexpr bool has_apply_options       = has_apply_options_method_v<_Type>;
    static constexpr bool has_configure           = has_configure_method_v<_Type>;
    static constexpr bool has_set_option          = has_set_option_method_v<_Type>;
    static constexpr bool has_get_option          = has_get_option_method_v<_Type>;
    static constexpr bool is_configurable         = is_configurable_container_v<_Type>;
    // option-producing
    static constexpr bool has_to_options          = has_to_options_method_v<_Type>;
    static constexpr bool has_get_options         = has_get_options_method_v<_Type>;
    static constexpr bool is_producing            = is_option_producing_container_v<_Type>;
    // CLI
    static constexpr bool has_parse_option        = has_parse_option_method_v<_Type>;
    static constexpr bool has_parse_args          = has_parse_args_method_v<_Type>;
    static constexpr bool has_parse_config        = has_parse_config_method_v<_Type>;
    static constexpr bool has_help_string         = has_help_string_method_v<_Type>;
    static constexpr bool is_cli_capable          = is_cli_capable_container_v<_Type>;
    // construction
    static constexpr bool has_from_options        = has_from_options_factory_v<_Type>;
    // strategies
    static constexpr option_configure_strategy configure_strategy = container_option_configure_strategy_v<_Type>;
    static constexpr option_parse_strategy parse_strategy         = container_option_parse_strategy_v<_Type>;
    // aggregate
    static constexpr bool has_option_support     = has_any_option_support_v<_Type>;
    static constexpr bool is_round_trip          = is_option_round_trip_capable_v<_Type>;
};
