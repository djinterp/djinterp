/******************************************************************************
* djinterp [container] container_overlay_concepts.hpp C++20 concepts for the
* OVERLAY axis -- the `requires`-facing view of container_overlay_traits.hpp.
...
* /inc/djinterp/core/container/concepts/container_overlay_concepts.hpp link(s):
...
D_CONCEPT_FROM_TRAIT(KeyedContainer, is_keyed_container_v)


// OrderBlindOverlayContainer
// concept: the overlay makes order unobservable, so two realizations differing
// only in order are the same container.
D_CONCEPT_FROM_TRAIT(OrderBlindOverlayContainer, is_order_blind_overlay_v)
