...
//   trait: true if _Type exposes first_child via field or method.
...
template<typename _Type>
struct has_first_child_field<_Type,
    D_VOID_T<decltype(std::declval<_Type>().first_child)>>
    : std::true_type
{};
...
template<typename _Type>
struct has_first_child_method<_Type,
    D_VOID_T<decltype(
        std::declval<const _Type&>().first_child())>>
    : std::true_type
{};
...
struct has_first_child_access
{
    static D_CONSTEXPR bool value =
        ( has_first_child_field<_Type>::value ||
...
//   trait: true if _Type exposes next_sibling via field or method.
template<typename _Type,
         typename = void>
...
template<typename _Type>
struct has_next_sibling_field<_Type,
    D_VOID_T<decltype(std::declval<_Type>().next_sibling)>>
    : std::true_type
{};
...
template<typename _Type>
struct has_next_sibling_method<_Type,
    D_VOID_T<decltype(
...
{
    static D_CONSTEXPR bool value =
        ( has_next_sibling_field<_Type>::value ||
          has_next_sibling_method<_Type>::value );
};
...
//   trait: true if _Type exposes prev_sibling via field or method.
template<typename _Type,
         typename = void>
...
template<typename _Type>
struct has_prev_sibling_field<_Type,
    D_VOID_T<decltype(std::declval<_Type>().prev_sibling)>>
    : std::true_type
{};
...
template<typename _Type>
struct has_prev_sibling_method<_Type,
    D_VOID_T<decltype(
        std::declval<const _Type&>().prev_sibling())>>
    : std::true_type
{};
...
{
    static D_CONSTEXPR bool value =
        ( has_prev_sibling_field<_Type>::value ||
          has_prev_sibling_method<_Type>::value );
};

#if D_ENV_CPP_FEATURE_LANG_VARIABLE_TEMPLATES
    template<typename _Type>
    D_CONSTEXPR bool has_prev_sibling_access_v =
        has_prev_sibling_access<_Type>::value;
#endif

// has_last_child_access
//   trait: true if _Type exposes last_child via field or method.
template<typename _Type,
         typename = void>
...
template<typename _Type>
struct has_last_child_field<_Type,
    D_VOID_T<decltype(std::declval<_Type>().last_child)>>
    : std::true_type
{};
...
template<typename _Type>
struct has_last_child_method<_Type,
    D_VOID_T<decltype(
        std::declval<const _Type&>().last_child())>>
    : std::true_type
{};
...
{
    static D_CONSTEXPR bool value =
        ( has_last_child_field<_Type>::value ||
          has_last_child_method<_Type>::value );
};

#if D_ENV_CPP_FEATURE_LANG_VARIABLE_TEMPLATES
    template<typename _Type>
    D_CONSTEXPR bool has_last_child_access_v =
        has_last_child_access<_Type>::value;
#endif

// --- Container model: children() returning an iterable ---

// has_children_method
//   trait: true if _Type has a children() method.
template<typename _Type,
         typename = void>
...
template<typename _Type>
struct has_children_method<_Type,
    D_VOID_T<decltype(
        std::declval<const _Type&>().children())>>
    : std::true_type
{};
...
NS_INTERNAL
    ...
    template<typename _Type>
    struct iterable_children_check<_Type,
        D_VOID_T<
            decltype(std::begin(
                std::declval<const _Type&>().children())),
            decltype(std::end(
...
struct has_iterable_children
    : internal::iterable_children_check<_Type>
{};
...
// has_edges_method
//   trait: true if _Type has an edges() method.
template<typename _Type,
         typename = void>
...
template<typename _Type>
struct has_edges_method<_Type,
    D_VOID_T<decltype(
        std::declval<const _Type&>().edges())>>
    : std::true_type
{};
...
//   trait: true if _Type has edge_count().
template<typename _Type,
         typename = void>
...
template<typename _Type>
struct has_edge_count_method<_Type,
    D_VOID_T<decltype(
        std::declval<const _Type&>().edge_count())>>
    : std::true_type
{};
    ...
    D_CONSTEXPR bool has_edge_count_method_v =
        has_edge_count_method<_Type>::value;
#endif
...
template<typename _Type>
struct has_parent_field<_Type,
    D_VOID_T<decltype(std::declval<_Type>().parent)>>
    : std::true_type
{};
...
template<typename _Type>
struct has_parent_method<_Type,
    D_VOID_T<decltype(
        std::declval<const _Type&>().parent())>>
    : std::true_type
{};
...
template<typename _Type>
struct has_child_count_method<_Type,
    D_VOID_T<decltype(
...
template<typename _Type>
struct has_is_leaf_method<_Type,
    D_VOID_T<decltype(
...
template<typename _Type>
struct has_append_child_method<_Type,
    D_VOID_T<decltype(
...
template<typename _Type>
struct has_prepend_child_method<_Type,
    D_VOID_T<decltype(
        std::declval<_Type&>().prepend_child(
            std::declval<decltype(
                std::declval<const _Type&>().root())>(),
            std::declval<decltype(
                std::declval<const _Type&>().root())>()))>>
...
template<typename _Type>
struct has_detach_method<_Type,
    D_VOID_T<decltype(
        std::declval<_Type&>().detach(
            std::declval<decltype(
                std::declval<const _Type&>().root())>()))>>
    : std::true_type
{};
...
template<typename _Type>
struct has_move_subtree_method<_Type,
    D_VOID_T<decltype(
        std::declval<_Type&>().move_subtree(
            std::declval<decltype(
                std::declval<const _Type&>().root())>(),
            std::declval<decltype(
                std::declval<const _Type&>().root())>()))>>
...
template<typename _Type>
struct has_insert_after_method<_Type,
    D_VOID_T<decltype(
        std::declval<_Type&>().insert_after(
            std::declval<decltype(
                std::declval<const _Type&>().root())>(),
            std::declval<decltype(
                std::declval<const _Type&>().root())>()))>>
...
template<typename _Type>
struct has_insert_before_method<_Type,
    D_VOID_T<decltype(
        std::declval<_Type&>().insert_before(
            std::declval<decltype(
                std::declval<const _Type&>().root())>(),
            std::declval<decltype(
                std::declval<const _Type&>().root())>()))>>
...
template<typename _Type>
struct has_stable_id_field<_Type,
    D_VOID_T<decltype(std::declval<const _Type&>().stable_id)>>
    : std::true_type
{};
...
template<typename _Type>
struct has_stable_id_method<_Type,
    D_VOID_T<decltype(
        std::declval<const _Type&>().stable_id())>>
    : std::true_type
{};
...
{
    static D_CONSTEXPR bool value =
        ( has_stable_id_field<_Type>::value ||
          has_stable_id_method<_Type>::value );
};
...
template<typename _Type>
struct has_version_field<_Type,
    D_VOID_T<decltype(std::declval<const _Type&>().version)>>
    : std::true_type
{};
...
template<typename _Type>
struct has_version_method<_Type,
    D_VOID_T<decltype(
        std::declval<const _Type&>().version())>>
    : std::true_type
{};
...
template<typename _Type>
struct has_bump_version_method<_Type,
    D_VOID_T<decltype(
        std::declval<_Type&>().bump_version(
            std::declval<decltype(
                std::declval<const _Type&>().root())>()))>>
    : std::true_type
{};
    ...
    D_CONSTEXPR bool has_bump_version_method_v =
        has_bump_version_method<_Type>::value;
#endif
...
NS_INTERNAL
    ...
    template<typename _Type>
    struct root_return_type_helper<_Type,
        D_VOID_T<decltype(
            std::declval<const _Type&>().root())>>
    {
...
{
    using type =
        typename internal::root_return_type_helper<_Type>::type;
};

template<typename _Type>
using root_handle_type_t =
    typename root_handle_type<_Type>::type;
...
{
    using handle = root_handle_type_t<_Type>;
...
// has_allocator_type
//   trait: true if _Type exposes allocator_type.
template<typename _Type,
         typename = void>
...
template<typename _Type>
struct has_allocator_type<_Type,
    D_VOID_T<typename _Type::allocator_type>>
    : std::true_type
{};
...
//   trait: true if _Type exposes a link_policy type alias.
template<typename _Type,
         typename = void>
...
template<typename _Type>
struct has_link_policy_type<_Type,
...
{};
    ...
    D_CONSTEXPR bool has_link_policy_type_v =
        has_link_policy_type<_Type>::value;
#endif

// has_payload_type
//   trait: true if _Type exposes payload_type.
template<typename _Type,
         typename = void>
...
{};
    ...
    D_CONSTEXPR bool has_payload_type_v =
        has_payload_type<_Type>::value;
#endif

// has_node_type_alias
//   trait: true if _Type exposes node_type.
template<typename _Type,
         typename = void>
...
template<typename _Type>
struct has_node_type_alias<_Type,
    D_VOID_T<typename _Type::node_type>>
    : std::true_type
{};
...
NS_INTERNAL
    ...
    template<typename _Type,
             bool _HasAlloc = has_allocator_type<_Type>::value,
             typename = void>
    struct pool_backed_check : std::false_type
    {};

    template<typename _Type>
    struct pool_backed_check<_Type, true,
        D_VOID_T<decltype(
            std::declval<
                const typename _Type::allocator_type&
            >().resource())>>
        : std::true_type
    {};
...
struct is_pool_backed
    : internal::pool_backed_check<_Type>
{};
...
NS_INTERNAL
    ...
    template<typename _Type>
    struct safe_node_type_helper<_Type,
        D_VOID_T<typename _Type::node_type>>
    {
    ...
    template<typename _Type>
    struct safe_payload_type_helper<_Type,
        D_VOID_T<typename _Type::payload_type>>
    {
    ...
    template<typename _Type>
    struct safe_value_type_helper<_Type,
        D_VOID_T<typename _Type::value_type>>
    {
...
struct nary_tree_node_type
    : internal::safe_node_type_helper<_Type>
{};

template<typename _Type>
using nary_tree_node_type_t =
    typename nary_tree_node_type<_Type>::type;
...
struct nary_tree_data_type
{
    using type = typename std::conditional<
        !std::is_void<
            typename internal::safe_payload_type_helper<_Type>::type
        >::value,
        typename internal::safe_payload_type_helper<_Type>::type,
        typename internal::safe_value_type_helper<_Type>::type
    >::type;
};

template<typename _Type>
using nary_tree_data_type_t =
    typename nary_tree_data_type<_Type>::type;
...
{
    static D_CONSTEXPR nary_child_access value =
        internal::child_access_strategy_impl<_Type>::value;
};

#if D_ENV_CPP_FEATURE_LANG_VARIABLE_TEMPLATES
    template<typename _Type>
    D_CONSTEXPR nary_child_access child_access_strategy_v =
        child_access_strategy<_Type>::value;
#endif
...
struct handle_form_strategy
{
    ...
    D_CONSTEXPR nary_handle_form handle_form_strategy_v =
        handle_form_strategy<_Type>::value;
#endif
...
struct memory_model_strategy
{
    ...
    D_CONSTEXPR nary_memory_model memory_model_strategy_v =
        memory_model_strategy<_Type>::value;
#endif
...
// is_nary_tree
//   trait: true if _Type has root access and at least one
...
// is_nary_node
//   trait: true if _Type is a node type (not container) that
...
struct nary_tree_class
{
    ...
    // -----------------------------------------------------------------
    using node_type =
        nary_tree_node_type_t<_Type>;
    using data_type =
        nary_tree_data_type_t<_Type>;
    using handle_type =
        root_handle_type_t<_Type>;
