...
{
    mysql_common::mysql_connect_config  mysql_config;
...
public:
    ...
    explicit mariadb_connection(const connection_config& _config)
        : base_type(_config)
    {
    }

    explicit mariadb_connection(
        const mysql_common::mysql_connect_config& _config)
        : base_type(_config)
    {
    }
