...
#ifndef DJINTERP_DATABASE_MYSQL_COMMON_CONCEPTS_
#define DJINTERP_DATABASE_MYSQL_COMMON_CONCEPTS_ 1
...
// escaping.
template<typename _Type>
concept mysql_escape_connection = has_mysql_escape<clean_t<_Type>>::value;
...
#endif  // DJINTERP_DATABASE_MYSQL_COMMON_CONCEPTS_
