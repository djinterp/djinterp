...
NS_DB
    ...
    class mariadb_table : public mysql_common::mysql_common_table<mariadb_connection,
                                                                  value,
                                                                  _Config>
    {
    private:
        using base_type = mysql_common::mysql_common_table<mariadb_connection,
                                                           value,
                                                           _Config>;
    ...
    protected:
        ...
        std::string build_insert_query(const row_type& _row) const
        {
            ...
            for (size_type c = 0; c < this->m_num_cols; ++c)
            {
                ...
                query += mysql_common::backtick_quote(
