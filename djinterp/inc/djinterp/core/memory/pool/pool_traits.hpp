/******************************************************************************
* djinterp [memory]                                            pool_traits.hpp
*
...
*     - pool_resource_type<T>          extracts the pool_resource type from a 
                                       pool_allocator (SFINAE-safe)
...
#ifndef DJINTERP_MEMORY_POOL_TRAITS_
#define DJINTERP_MEMORY_POOL_TRAITS_ 1
...
struct is_pool_backed_container
{
    ...
    static constexpr bool value =
        ( has_allocator_type_v<clean_type> &&
          is_pool_allocator_v<typename clean_type::allocator_type> );
};
...
#endif  // DJINTERP_MEMORY_POOL_TRAITS_