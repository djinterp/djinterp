/******************************************************************************
* djinterp [utility]                                      pdf_template_traits.hpp
*
...
#ifndef DJINTERP_UTIL_PDF_TEMPLATE_TRAITS_
#define DJINTERP_UTIL_PDF_TEMPLATE_TRAITS_ 1
...
struct has_document_lifecycle
{
    static constexpr bool value =
        ( has_begin_document_method<clean_t<_Type>>::value &&
          has_end_document_method<clean_t<_Type>>::value );
};
...
{
    static constexpr bool value =
        ( has_begin_page_method<clean_t<_Type>>::value &&
          has_end_page_method<clean_t<_Type>>::value );
};
...
{
    static constexpr bool value =
        ( has_draw_text_method<clean_t<_Type>>::value &&
          has_draw_line_method<clean_t<_Type>>::value &&
          has_draw_rect_method<clean_t<_Type>>::value );
};
...
{
    static constexpr bool value =
        ( has_serialize_method<clean_t<_Type>>::value &&
          has_save_method<clean_t<_Type>>::value );
};
...
{
    static constexpr bool value =
        ( has_document_lifecycle<clean_t<_Type>>::value     &&
          has_page_lifecycle<clean_t<_Type>>::value         &&
          has_drawing_protocol<clean_t<_Type>>::value       &&
          has_set_metadata_method<clean_t<_Type>>::value    &&
          has_capabilities_method<clean_t<_Type>>::value    &&
          has_output_protocol<clean_t<_Type>>::value );
};
...
{
    static constexpr bool value =
        ( has_open_method<clean_t<_Type>>::value       &&
          has_close_method<clean_t<_Type>>::value      &&
          has_add_page_method<clean_t<_Type>>::value   &&
          has_text_method<clean_t<_Type>>::value       &&
          has_save_method<clean_t<_Type>>::value );
};
...
struct pdf_class
{
    ...
    static constexpr bool has_page_lifecycle =
        ::djinterp::has_page_lifecycle<clean_t<_Type>>::value;
    ...
    static constexpr bool is_backend =
        is_pdf_backend<clean_t<_Type>>::value;
    ...
    static constexpr bool is_document =
        is_pdf_document<clean_t<_Type>>::value;
};
...
#endif  // DJINTERP_UTIL_PDF_TEMPLATE_TRAITS_