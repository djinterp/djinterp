...
*
*
* path:      /inc/djinterp/core/pdf/pdf_metrics.hpp
* link(s):   TBA
* author(s): Samuel 'teer' Neal-Blim                       created: 2026.05.22
******************************************************************************/

#ifndef DJINTERP_PDF_METRICS_
#define DJINTERP_PDF_METRICS_ 1
