...
*                  `val_t<>` / `fixed_string` surface test_config uses), lowered
...
*
*
* path:      /inc/djinterp/core/pdf/pdf_options.hpp
* link(s):   TBA
* author(s): Samuel 'teer' Neal-Blim                       created: 2026.06.25
******************************************************************************/

#ifndef DJINTERP_PDF_OPTIONS_
#define DJINTERP_PDF_OPTIONS_ 1
...
// setters and a small fold over the schema's flat option tuple, exactly as
// test_options_lower distils a test_config.  build() seeds the pdf_options
