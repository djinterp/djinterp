...
*
*
* path:      /inc/djinterp/core/pdf/pdf_canvas.hpp
* link(s):   TBA
* author(s): Samuel 'teer' Neal-Blim                       created: 2026.05.22
******************************************************************************/

#ifndef DJINTERP_PDF_CANVAS_
#define DJINTERP_PDF_CANVAS_ 1
