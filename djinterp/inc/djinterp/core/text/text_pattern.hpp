...
#ifndef D_TEXT_PAT_DEFAULT_PREFIX
    #define D_TEXT_PAT_DEFAULT_PREFIX    "%"
#endif

#ifndef D_TEXT_PAT_DEFAULT_SUFFIX
    #define D_TEXT_PAT_DEFAULT_SUFFIX    "%"
#endif

#ifndef D_TEXT_PAT_DEFAULT_ESCAPE
    #define D_TEXT_PAT_DEFAULT_ESCAPE    '\\'
#endif
...
// segment count.
class text_pattern : public pattern<text_pattern>
{
public:
