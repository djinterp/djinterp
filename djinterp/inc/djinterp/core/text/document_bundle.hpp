...
*
*
* path:      /inc/djinterp/core/util/document_bundle.hpp
* link(s):   TBA
...
#ifndef DJINTERP_UTILITY_DOCUMENT_BUNDLE_
#define DJINTERP_UTILITY_DOCUMENT_BUNDLE_ 1
...
#include "./compress.hpp"                  // byte_buffer, status, internal leaves
...
#endif  // DJINTERP_UTILITY_DOCUMENT_BUNDLE_