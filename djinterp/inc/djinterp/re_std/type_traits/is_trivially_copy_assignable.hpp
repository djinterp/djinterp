...
*
*
* path:      /inc/djinterp/re_std/type_traits/is_trivially_copy_assignable.hpp
* link(s):   TBA
...
// =============================================================================
    ...
    template<typename _Type>
    D_CONSTEXPR bool is_trivially_copy_assignable_v =
        is_trivially_copy_assignable<_Type>::value;
