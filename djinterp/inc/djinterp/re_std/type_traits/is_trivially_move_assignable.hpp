/******************************************************************************
* djinterp [restd]                              is_trivially_move_assignable.hpp
*
...
#ifndef DJINTERP_RESTD_TYPE_TRAITS_IS_TRIVIALLY_MOVE_ASSIGNABLE_
#define DJINTERP_RESTD_TYPE_TRAITS_IS_TRIVIALLY_MOVE_ASSIGNABLE_ 1
...
// =============================================================================
    ...
    template<typename _Type>
    D_CONSTEXPR bool is_trivially_move_assignable_v =
...
#endif  // DJINTERP_RESTD_TYPE_TRAITS_IS_TRIVIALLY_MOVE_ASSIGNABLE_
