/******************************************************************************
* djinterp [restd]                                                iter_move.hpp
*
* iter_move header:
*   Provides the C++20 restd::iter_move customisation point object
* (niebloid) and the iter_rvalue_reference_t<I> alias. In standard
* C++ these live in std::ranges:: and <iterator>; restd keeps them
* in the flat restd:: namespace to match the rest of the codebase.
*
...
#ifndef DJINTERP_RESTD_ITERATOR_ITER_MOVE_
#define DJINTERP_RESTD_ITERATOR_ITER_MOVE_ 1
...
//   alias: the type yielded by restd::iter_move on iterator type _I.
template<typename _I>
struct iter_rvalue_reference
{
    typedef decltype(restd::iter_move(declval<_I&>())) type;
};
...
#endif  // DJINTERP_RESTD_ITERATOR_ITER_MOVE_
