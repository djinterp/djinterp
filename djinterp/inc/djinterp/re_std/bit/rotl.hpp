/******************************************************************************
* djinterp [re_std]                                                     rotl.hpp
*
* rotl header:
*   Rotates the bits of the value left by _s positions. Bits shifted
...
*
*
* path:      /inc/djinterp/re_std/bit/rotl.hpp
* link(s):   TBA
* author(s): TBA                                           created: 2026.08.25
******************************************************************************/

#ifndef DJINTERP_RE_STD_BIT_ROTL_
#define DJINTERP_RE_STD_BIT_ROTL_ 1
...
{
    return internal::rotl_reduced<_T>(
        _v,
...
#endif  // DJINTERP_RE_STD_BIT_ROTL_
