...
#ifndef DJINTERP_RE_STD_FUNCTIONAL_LESS_EQUAL_
#define DJINTERP_RE_STD_FUNCTIONAL_LESS_EQUAL_ 1
...
// less_equal
//   class: function object performing less-or-equal test (<=).
...
#endif  // DJINTERP_RE_STD_FUNCTIONAL_LESS_EQUAL_
