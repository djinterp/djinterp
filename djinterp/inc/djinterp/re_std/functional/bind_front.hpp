...
* inspection: a bind expression passed to bind_front is stored and forwarded as an
* ordinary functor rather than being invoked with the call arguments.  That is
* deliberate in std, and it is why bind_front composes predictably where bind can
...
*
*   STD IS C++20; re_std IS C++11 - the machinery needs only variadic
