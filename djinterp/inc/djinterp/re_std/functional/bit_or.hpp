...
*
*
* path:      /inc/djinterp/re_std/functional/bit_or.hpp
* link(s):   TBA
* author(s): re_std                                      date: 2026.05.07
***********************************************************************/

#ifndef DJINTERP_RE_STD_FUNCTIONAL_BIT_OR_
#define DJINTERP_RE_STD_FUNCTIONAL_BIT_OR_ 1
...
#endif  // DJINTERP_RE_STD_FUNCTIONAL_BIT_OR_
