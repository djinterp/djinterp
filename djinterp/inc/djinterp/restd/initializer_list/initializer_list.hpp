...
*   cannot be reimplemented portably. restd therefore surfaces it via an
*   identity-preserving using-declaration: restd::initializer_list IS
...
#ifndef RESTD_INITIALIZER_LIST_INITIALIZER_LIST_
#define RESTD_INITIALIZER_LIST_INITIALIZER_LIST_ 1
...
// std
//   <initializer_list> is one of the few standard headers restd is permitted
...
NS_RESTD
    ...
    // std::initializer_list, so restd::initializer_list IS that same type.
...
#endif  // RESTD_INITIALIZER_LIST_INITIALIZER_LIST_
