/******************************************************************************
* djinterp [restd]                              is_nothrow_copy_constructible.hpp
*
* is_nothrow_copy_constructible trait header:
*   Equivalent to is_nothrow_constructible<_Type, _Type const&>.
*
*
* path:      /inc/djinterp/restd/type_traits/is_nothrow_copy_constructible.hpp
* link(s):   TBA
* author(s): Samuel 'teer' Neal-Blim                       created: 2026.04.28
******************************************************************************/

#ifndef DJINTERP_RESTD_TYPE_TRAITS_IS_NOTHROW_COPY_CONSTRUCTIBLE_
#define DJINTERP_RESTD_TYPE_TRAITS_IS_NOTHROW_COPY_CONSTRUCTIBLE_ 1
...
#endif  // DJINTERP_RESTD_TYPE_TRAITS_IS_NOTHROW_COPY_CONSTRUCTIBLE_
