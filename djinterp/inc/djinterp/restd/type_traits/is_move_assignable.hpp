/******************************************************************************
* djinterp [restd]                                       is_move_assignable.hpp
*
* is_move_assignable trait header:
*   Equivalent to is_assignable<_Type&, _Type&&>.
*
*
* path:      /inc/djinterp/restd/type_traits/is_move_assignable.hpp
* link(s):   TBA
* author(s): Samuel 'teer' Neal-Blim                       created: 2026.04.28
******************************************************************************/

#ifndef DJINTERP_RESTD_TYPE_TRAITS_IS_MOVE_ASSIGNABLE_
#define DJINTERP_RESTD_TYPE_TRAITS_IS_MOVE_ASSIGNABLE_ 1
...
#endif  // DJINTERP_RESTD_TYPE_TRAITS_IS_MOVE_ASSIGNABLE_
