...
*   ND: x₀, x₁, ..., x_{N-1}
*
* path:      /inc/maths/cartesian.hpp
* link:      TBA
* author(s): Samuel 'teer' Neal-Blim                       date: 2026.02.06
******************************************************************************/

#ifndef DJINTERP_MATHS_CARTESIAN_
#define DJINTERP_MATHS_CARTESIAN_ 1
...
#endif  // DJINTERP_MATHS_CARTESIAN_
