...
* is resolved via djinterp::resolve_self, enabling raw pointer, smart
...
*   - links()            — reference to the underlying link array
*   - num_links          — compile-time link count
*
* path:      \inc\containers\linked_node.hpp
* author(s): Samuel 'teer' Neal-Blim                          date: 2026.03.22
******************************************************************************/

#ifndef DJINTERP_LINKED_NODE_
#define DJINTERP_LINKED_NODE_ 1
...
NS_CONTAINER
    ...
    public:
        ...
        // Renamed to edges() to harmonize with dynamic_node and iterators
...
#endif  // DJINTERP_CONTAINER_LINKED_NODE_