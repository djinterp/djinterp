...
// has_symbol_function
//   trait: true if _T exposes symbol_function() returning
// a callable.
...
template<typename _T>
struct has_symbol_function<_T, D_VOID_T<
    decltype(std::declval<const _T&>().symbol_function())
>> : std::true_type
{};

// has_set_symbol_function
//   trait: true if _T exposes set_symbol_function(fn).
template<typename _T,
         typename = void>
...
template<typename _T>
struct has_set_symbol_function<_T, D_VOID_T<
    decltype(std::declval<_T&>().set_symbol_function(
...
//   trait: true if _T exposes status_string_function().
template<typename _T,
         typename = void>
...
template<typename _T>
struct has_status_string_function<_T, D_VOID_T<
    decltype(std::declval<const _T&>().status_string_function())
>> : std::true_type
{};
...
// has_numbering_mode
//   trait: true if _T exposes numbering_mode().
template<typename _T,
         typename = void>
...
template<typename _T>
struct has_numbering_mode<_T, D_VOID_T<
    decltype(std::declval<const _T&>().numbering_mode())
>> : std::true_type
{};

// has_set_numbering_mode
//   trait: true if _T exposes set_numbering_mode(...).
template<typename _T,
         typename = void>
...
template<typename _T>
struct has_set_numbering_mode<_T, D_VOID_T<
    decltype(std::declval<_T&>().set_numbering_mode(
        std::declval<int>()))
>> : std::true_type
{};
...
struct has_numbering_support
{
    static constexpr bool value =
        ( has_numbering_mode<_T>::value &&
          has_set_numbering_mode<_T>::value );
};
...
// has_header_template
//   trait: true if _T exposes header_template().
template<typename _T,
         typename = void>
...
template<typename _T>
struct has_header_template<_T, D_VOID_T<
    decltype(std::declval<const _T&>().header_template())
>> : std::true_type
{};

// has_footer_template
//   trait: true if _T exposes footer_template().
template<typename _T,
         typename = void>
...
template<typename _T>
struct has_footer_template<_T, D_VOID_T<
    decltype(std::declval<const _T&>().footer_template())
>> : std::true_type
{};

// has_section_header_template
//   trait: true if _T exposes section_header_template().
template<typename _T,
         typename = void>
...
template<typename _T>
struct has_section_header_template<_T, D_VOID_T<
    decltype(std::declval<const _T&>().section_header_template())
>> : std::true_type
{};

// has_section_footer_template
//   trait: true if _T exposes section_footer_template().
template<typename _T,
         typename = void>
...
template<typename _T>
struct has_section_footer_template<_T, D_VOID_T<
    decltype(std::declval<const _T&>().section_footer_template())
>> : std::true_type
{};
...
{
    static constexpr bool value =
        ( has_header_template<_T>::value         &&
          has_footer_template<_T>::value         &&
          has_section_header_template<_T>::value  &&
          has_section_footer_template<_T>::value );
};
...
//   trait: true if _T exposes print_node(...).
template<typename _T,
         typename = void>
...
template<typename _T>
struct has_print_node_method<_T, D_VOID_T<
    decltype(std::declval<const _T&>().print_node(
...
//   trait: true if _T exposes print_summary(...).
template<typename _T,
         typename = void>
...
template<typename _T>
struct has_print_summary_method<_T, D_VOID_T<
    decltype(std::declval<const _T&>().print_summary())
>> : std::true_type
{};

// has_print_header_method
//   trait: true if _T exposes print_header(...).
template<typename _T,
         typename = void>
...
template<typename _T>
struct has_print_header_method<_T, D_VOID_T<
    decltype(std::declval<const _T&>().print_header())
>> : std::true_type
{};
...
//   trait: true if _T exposes set_node_filter(fn).
template<typename _T,
         typename = void>
...
template<typename _T>
struct has_node_filter_method<_T, D_VOID_T<
    decltype(std::declval<_T&>().set_node_filter(
        std::declval<std::function<
...
// has_status_filter
//   trait: true if _T exposes set_print_passing(bool)
...
template<typename _T>
struct has_status_filter<_T, D_VOID_T<
    decltype(std::declval<_T&>().set_print_passing(
        std::declval<bool>())),
    decltype(std::declval<_T&>().set_print_skipped(
        std::declval<bool>()))
>> : std::true_type
{};
...
struct test_printer_class
{
    ...
    static constexpr bool has_symbol_fn =
        has_symbol_function<_T>::value;
    static constexpr bool has_set_symbol_fn =
        has_set_symbol_function<_T>::value;
    static constexpr bool has_status_str_fn =
        has_status_string_function<_T>::value;

    // numbering
    static constexpr bool has_numbering =
        has_numbering_support<_T>::value;
