...
/*
main
  Entry point for the test_module standalone unit test suite.
  Initializes the unified test runner, registers the test_module module,
parses CLI options, executes all tests, and returns the exit status.
...
)
{
    ...
    d_test_sa_runner_init(&runner,
                          "test_module",
                          "Standalone unit tests for test_module.h");
    ...
    // register the test_module test module
    d_test_sa_runner_add_module_counter(
        &runner,
        "test_module",
        "Unit tests for the d_test_module structure and API",
