/******************************************************************************
* djinterp [functional]                                 result_test_runner.cpp
*
*   Entry point for the result.hpp unit-test binary. This is the main holder,
* not a reusable module: it pulls in the DTest section functions declared in
* result_tests.hpp and drives the whole suite inline from main().
*
*   WHAT main() DOES:
*   It walks a local manifest -- one entry per like-group semantic section
* of result.hpp -- and for each section: emits a banner, runs the section
...
*
*   RELATIONSHIP TO result_module_run_all / run_session:
*   result_tests.hpp also exposes the module_info + module_run_all pair for
...
* that the section list lives here as well as in result_module_run_all -- keep
...
*
*
* path:      /inc/functional/result_test_runner.cpp
* link(s):   TBA
...
#include "../../../../../../../tests/djinterp/core/functional/result_tests.hpp"


using djinterp::test::test_handler;
using djinterp::test::session_result;
using djinterp::testing::test_construction;
using djinterp::testing::test_assignment;
using djinterp::testing::test_observers;
using djinterp::testing::test_lifetime;
using djinterp::testing::test_map;
using djinterp::testing::test_map_err;
using djinterp::testing::test_and_then;
using djinterp::testing::test_or_else;
using djinterp::testing::test_match;
using djinterp::testing::test_equality;
using djinterp::testing::test_traits;
using djinterp::testing::test_factories;
using djinterp::testing::test_combinators;
using djinterp::testing::test_conversions;
using djinterp::testing::test_monad_traits;
using djinterp::testing::test_collect;
using djinterp::testing::test_combine;
...
namespace {
    ...
    ) D_NOEXCEPT
    {
        ...
        {
            case verdict_passed:
                return "[PASS] ALL RESULT TESTS PASSED";

            case verdict_failed:
                return "[FAIL] SOME RESULT TESTS FAILED";

            case verdict_empty:
                return "[EMPTY] NO RESULT CHECKS OBSERVED";
...
main()
{
    ...
    // adapts. Keep this list in step with result_module_run_all.
    ...
    const section_entry sections[] =
    {
        ...
        { "observers", &test_observers },
        { "lifetime", &test_lifetime },
        { "map", &test_map },
        { "map_err", &test_map_err },
        { "and_then", &test_and_then },
        { "or_else", &test_or_else },
        { "match", &test_match },
        ...
        { "monad_traits", &test_monad_traits },
    ...
    suite_name         = "djinterp / functional / result";
    suite_description  = "Lifetime, the transform methods, equality, "
                         "structural traits, factories, the combinator "
                         "pipeline, maybe conversions, and monad_traits for "
                         "result.hpp";
    suite_path         = "/inc/djinterp/core/functional/result.hpp";
    ...
    std::printf("\n");
    print_rule();
    std::printf("  RESULT TEST SUITE SUMMARY\n");
    print_rule();
