/******************************************************************************
* djinterp [functional]                               pipeline_test_runner.cpp
*
*   Entry point for the pipeline.hpp unit-test binary. This is the main holder,
* not a reusable module: it pulls in the DTest section functions declared in
* pipeline_tests.hpp and drives the whole suite inline from main().
*
*   WHAT main() DOES:
*   It walks a local manifest -- one entry per like-group semantic section
* of pipeline.hpp -- and for each section: emits a banner, runs the section
...
*
*   RELATIONSHIP TO pipeline_module_run_all / run_session:
*   pipeline_tests.hpp also exposes the module_info + module_run_all pair for
...
* that the section list lives here as well as in pipeline_module_run_all -- keep
...
*
*
* path:      /inc/functional/pipeline_test_runner.cpp
* link(s):   TBA
...
#include "../../../../../../../tests/djinterp/core/functional/pipeline_tests.hpp"


using djinterp::test::test_handler;
using djinterp::test::session_result;
using djinterp::testing::test_creation;
using djinterp::testing::test_map;
using djinterp::testing::test_filter;
using djinterp::testing::test_distinct;
using djinterp::testing::test_flat_map;
using djinterp::testing::test_take;
using djinterp::testing::test_skip;
using djinterp::testing::test_slice;
using djinterp::testing::test_reorder;
using djinterp::testing::test_fold;
using djinterp::testing::test_reduce;
using djinterp::testing::test_group_by;
using djinterp::testing::test_partition;
using djinterp::testing::test_zip_with;
using djinterp::testing::test_query;
using djinterp::testing::test_for_each;
using djinterp::testing::test_accessors;
using djinterp::testing::test_iteration;
using djinterp::testing::test_error_propagation;
using djinterp::testing::test_traits;
using djinterp::testing::test_factory;
...
namespace {
    ...
    ) D_NOEXCEPT
    {
        ...
        {
            case verdict_passed:
                return "[PASS] ALL PIPELINE TESTS PASSED";

            case verdict_failed:
                return "[FAIL] SOME PIPELINE TESTS FAILED";

            case verdict_empty:
                return "[EMPTY] NO PIPELINE CHECKS OBSERVED";
...
main()
{
    ...
    // adapts. Keep this list in step with pipeline_module_run_all.
    ...
    suite_name         = "djinterp / functional / pipeline";
    suite_description  = "Creation, the transforming operations, slicing and "
                         "reordering, the aggregating operations, queries, "
                         "accessors and iteration, error propagation, "
                         "traits, and the factory for pipeline.hpp";
    suite_path         = "/inc/djinterp/core/functional/pipeline.hpp";
    ...
    std::printf("\n");
    print_rule();
    std::printf("  PIPELINE TEST SUITE SUMMARY\n");
    print_rule();
