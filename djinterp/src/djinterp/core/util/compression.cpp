/*******************************************************************************
* djinterp [core]                                              compression.cpp
*
*   Implementation of the djinterp portable compression facade. This unit
* holds every backend that compression.hpp forwards to. Each backend is gated
* on the matching D_ENV_COMPRESSION_HAVE_* flag from env_compression.h, and the
* third-party headers are included here (not in the public header), so merely
* including compression.hpp never pulls in a dependency.
*
...
*
* path:      /src/cpp/compression.cpp
* link(s):   TBA
* author(s): Samuel 'teer' Neal-Blim                          date: 2026.05.23
*******************************************************************************/

#include "../../inc/cpp/compression.hpp"
