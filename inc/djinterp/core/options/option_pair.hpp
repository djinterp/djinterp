...
*
*
* path:      /inc/options/option_pair.hpp
* link(s):   TBA
...
struct option_pair
{
    ...
    constexpr bool
    operator==(const option_pair& _other) const
    {
...
// function-to-pointer, and cv-ref stripping occur automatically.
//
// Example:
