...
*     Backing       vector → deque (etc.)   O(n) copy
...
*
*
* path:      \inc\container\meta\container_constructive_traits.hpp
* link(s):   TBA
...
// iterator range.  This is the universal fallback for
...
// insert, or element-wise push_back with compatible
// types).
template<typename _From,
         typename _To>
