...
*
*   PORTABILITY:
*   This header requires C++17 or later. It does not include <oci.h>;
* the concrete _impl method definitions in oracle.cpp include it.
*
* path:      \inc\database\oracle\oracle.hpp
* link:      TBA
